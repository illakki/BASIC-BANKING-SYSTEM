...
<body>
    ...
    include './navbar.php';
    ?>
    <div class="center mt-0 #FF1565C0 amber accent-3">
        <h3><b><span><img src="https://png.pngtree.com/png-clipart/20190619/original/pngtree-concept-banking-logo-png-image_4017933.jpg" style="height:60px;width:50px" /></span>Money Transfer</b></h3>
    </div>
    <div class="container">
        <br />
        <div class="row">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center py-2">savings </th>
